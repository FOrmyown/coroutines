...
import static com.as.suspension.instrumenter.generators.GenericGenerators.addLabel;
...
import static com.as.suspension.instrumenter.generators.GenericGenerators.jumpTo;
...
public final class SimpleClassWriterTest {
    ...
    public void setUp() throws IOException {
        byte[] classData = TestUtils.readZipFromResource("SimpleStub.zip").get("SimpleStub.class");
