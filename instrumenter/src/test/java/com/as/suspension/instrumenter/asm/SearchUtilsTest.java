...
import static com.as.suspension.instrumenter.asm.SearchUtils.findInvocationsOf;
import static com.as.suspension.instrumenter.asm.SearchUtils.findInvocationsWithParameter;
import static com.as.suspension.instrumenter.asm.SearchUtils.findLocalVariableNodeForInstruction;
import static com.as.suspension.instrumenter.asm.SearchUtils.findMethod;
import static com.as.suspension.instrumenter.asm.SearchUtils.findMethodsWithName;
import static com.as.suspension.instrumenter.asm.SearchUtils.findMethodsWithParameter;
import static com.as.suspension.instrumenter.asm.SearchUtils.findMethodsWithParameters;
import static com.as.suspension.instrumenter.asm.SearchUtils.findStaticMethods;
...
public final class SearchUtilsTest {
    ...
    public void setUp() throws IOException {
        classNode = TestUtils.readZipResourcesAsClassNodes("SearchUtilsStubs.zip").get("SearchUtilsStubs.class");
    }
    ...
    public void mustFindStaticMethods() throws IOException {
        classNode = TestUtils.readZipResourcesAsClassNodes("StaticInvokeTest.zip").get("StaticInvokeTest.class");
