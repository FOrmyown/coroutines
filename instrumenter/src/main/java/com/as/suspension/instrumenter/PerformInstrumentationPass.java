...
final class PerformInstrumentationPass implements InstrumentationPass {
    ...
    public void pass(ClassNode classNode, InstrumentationState state) {
        ...
        FieldNode instrumentedMarkerField = new FieldNode(
                InternalFields.INSTRUMENTED_MARKER_FIELD_ACCESS,
                InternalFields.INSTRUMENTED_MARKER_FIELD_NAME,
                InternalFields.INSTRUMENTED_MARKER_FIELD_TYPE.getDescriptor(),
                null,
                InternalFields.INSTRUMENTED_MARKER_FIELD_VALUE);
